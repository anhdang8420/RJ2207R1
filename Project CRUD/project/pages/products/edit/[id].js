                                            ...
                                            <div className="card-body p-4 text-center">
                                                ...
                                                <div className="form-outline mb-2">
                                                    <Field className="form-control" as="select" name="cate_id" value={product.cate_id || ''}>
                                                        <option className=" selected" >Chọn thể loại</option>
                                                        {
                                                ...
                                                <div className="form-outline mb-2">
                                                    <Field className="form-control" name="image" placeholder="Nhập link ảnh" />
                                                    <ErrorMessage component="div" className="text-danger" name="image" />
                                                </div>
                                                <div className="form-outline mb-2">
                                                    <Field className="form-control" name="author" placeholder="Nhập tên tác giả" />
                                                    <ErrorMessage component="div" className="text-danger" name="author" />
                                                </div>
                                                <div className="form-outline mb-2">
                                                    <Field className="form-control" name="quantity" placeholder="Nhập số lượng" />
                                                    <ErrorMessage component="div" className="text-danger" name="quantity" />
                                                </div>
                                                <div className="form-outline mb-2">
                                                    <Field className="form-control" name="price" placeholder="Nhập giá tiền" />
